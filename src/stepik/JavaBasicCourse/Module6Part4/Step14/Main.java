package stepik.JavaBasicCourse.Module6Part4.Step14;
...
public class Main {
    ...
    private static class MailMessage implements Message<String> {
    ...
    private static class Salary implements Message<Integer> {
        private final String from;
        private final String to;
    ...
    private static class MailService <T> implements Consumer<Message<T>> {
        ...
        public void accept(Message<T> message) {
            ...
            if (!mailBox.containsKey(to))
                mailBox.put(
                        to,
                        new ArrayList<>(
                                Collections.singleton(message.getContent())
                        )
                );
            else
